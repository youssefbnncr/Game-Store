...
async function updateItem(itemId, name, description, year, quantity) {
  await pool.query(
    'UPDATE items SET name = $1, description = $2, year = $3, quantity = $4 WHERE id = $5',
    [name, description, year, quantity, itemId]
  );
}
